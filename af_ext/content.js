...
(() => {
    ...
    const FORM_FIELD_SELECTOR = "input, select, textarea, spl-autocomplete, spl-select, spl-input, [contenteditable='true'], [role='textbox'], [role='combobox'], [data-test='location-autocomplete']";
